		...
		<div id="main">
			<form class="form-inline " style="padding: 3% 5% 0% 5%;" role="form">
				<div class="input-group">
					...
					<input type="date" class="form-control"  id ="beginTime"placeholder="twitterhandle">
				</div>
				<div class="input-group">
					<span class="input-group-addon">结束时间</span>
					<input type="date" class="form-control" id="endTime" placeholder="twitterhandle">
				</div>

				<div class="form-group ">
					<input type="text" class="form-control" id="positonName" placeholder="请输入部门名称">
				</div>
